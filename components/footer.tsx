      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12 border-t border-slate-900 pt-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li><Link href="/#servicos" className="hover:text-cyan-400 transition-colors">Soluções</Link></li>
              <li><Link href="/portfolio" className="hover:text-cyan-400 transition-colors">Portfólio</Link></li>
              <li><Link href="/#processo" className="hover:text-cyan-400 transition-colors">Como Funciona</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
          <p>&copy; {new Date().getFullYear()} Atlas Soluções Digitais. Todos os direitos reservados.</p>
